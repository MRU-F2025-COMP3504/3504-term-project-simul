...
Server actions can call the Piston API via a wrapper (see `src/actions/piston-actions/execute-code-tests.ts`). Input is validated with Zod, and code execution is performed in a sandboxed container.
